...
export class ServiceModelData{
    public value:any=[
        ...
        },
        {
            ...
            within 2 hours for services at best prices.`
        },
        {
            'id':5,
            'name':'Doctor',
            ...
            consultation at home at your doorstep.`
        },
        {
            'id':6,
            'name':'Chemist',
        ...
        },
        {
            ...
            'name':'Gym',
            'icon':'athlete.png',
            'message':`Successfully delivered a complete fitness lifestyle to our members.`
        }
    ]
}